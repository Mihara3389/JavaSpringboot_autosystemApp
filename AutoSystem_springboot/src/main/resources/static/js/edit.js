function appendRow()
{
    ...
    // 各列に表示内容を設定
    c1.innerHTML = '<td> &emsp;&emsp;&emsp;&emsp;&emsp;</td>';
    c2.innerHTML = '<td><input type="text" id="answer" name="answer">'+
   				   '<input type="hidden" id="answer_id' + count + '" name="answer_id"  ></td>';
